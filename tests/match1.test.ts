...
const scoreAndTest = (
    ...
    if (!how) {
        ...
        how =
            winner === server ? PointOutcomes.ACE : PointOutcomes.RETURN_WINNER;
    }
...
describe("Match 1", () => {
    ...
    it("Checking set 2 game 2", () => {
        ...
        scoreAndTest(2, [0, 1, 40, 0, 0, 40]); // Deuce
        scoreAndTest(1, [0, 1, "ADV", 0, 0, "-"]); // Adv P1
        scoreAndTest(2, [0, 1, "DEUCE", 0, 0, "DEUCE"]); // Deuce
        scoreAndTest(2, [0, 1, "-", 0, 0, "ADV"]); // Adv P2
    ...
    it("Checking set 1 game 3", () => {
        ...
        scoreAndTest(1, [0, 1, 40, 0, 1, 40]); // Deuce
        scoreAndTest(1, [0, 1, "ADV", 0, 1, "-"]); // Adv P1
        scoreAndTest(2, [0, 1, "DEUCE", 0, 1, "DEUCE"]); // Deuce
        scoreAndTest(2, [0, 1, "-", 0, 1, "ADV"]); // Adv P2
        scoreAndTest(1, [0, 1, "DEUCE", 0, 1, "DEUCE"]); // Deuce
        undoAndTest([0, 1, "-", 0, 1, "ADV"]); // Undo, back to Adv P2
