...
export interface ParticipantFactory {
  ...
  createFromLegacy(data: any): AnyParticipant;
}
...
/**
 * Maps legacy point outcomes to new standardized outcomes.
 */
export const LEGACY_OUTCOME_MAP: Record<string, PointOutcome> = {
  ACE: PointOutcome.Ace,
  DOUBLE_FAULT: PointOutcome.DoubleFault,
  SERVICE_WINNER: PointOutcome.ServiceWinner,
  RETURN_WINNER: PointOutcome.ReturnWinner,
  WINNER: PointOutcome.Winner,
  UNFORCED_ERROR: PointOutcome.UnforcedError,
  FORCED_ERROR: PointOutcome.ForcedError,
  REGULAR: PointOutcome.Regular,
};
...
/**
 * Legacy match summary format for backward compatibility.
 */
